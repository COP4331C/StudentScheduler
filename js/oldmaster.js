...
function task(id, name, building, time, date, notes) {
	
	this.id = id;
	this.name = name;
	this.building = building;
	this.tasktime = convertTime(time);
	this.taskdate = date;
	this.notes = note;
...
{
	console.log("ho is this running");
	var jsonPaylod = JSON.stringify({name:task.name, building:task.building, tasktime:task.tasktime, taskdate:task.taskdate, notes:task.notes});
	var url = urlBase + "createTask3.0" + extension
