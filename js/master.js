		...
		if (item.toString() == "event") {
			...
			$('#homepage').append(`
				<div class="card mb-3 text-center" id="homeevent` + item.id + `">
					<div class="card-header">
						<a data-toggle="collapse" data-target="#map` + item.id + `collapse" style="font-size:14px;">
							<i class="fa fa-angle-down float-right"></i>
							` + item.courseName + `
						</a>
					</div>
					<div id="eventreminder` + item.id + `">No reminders</div>
					<div id="map` + item.id + `collapse" class="collapse show">
						<div class="card-body" style="padding-top:0; padding-left:5px; padding-right:5px">
							<div class="tab-pane container-fluid" style="padding-left:0;padding-right:0" id="event` + item.id + `maps">
								<ul class="nav nav-tabs nav-justified">
									<li class="nav-item">
										<a class="nav-link active" data-toggle="tab" href="#eventwalk` + item.id + `">
											<div><i class="fa fa-walking"></i></div>
											<div style="font-size:12px">1h 38m</div>
										</a>
									</li>
									<li class="nav-item">
										<a class="nav-link" data-toggle="tab" href="#eventbike` + item.id + `">
											<div><i class="fa fa-bicycle"></i></div>
											<div style="font-size:12px">25m</div>
										</a>
									</li>
									<li class="nav-item">
										<a class="nav-link" data-toggle="tab" href="#eventcar` + item.id + `">
											<div><i class="fa fa-car"></i></div>
											<div style="font-size:12px">9m</div>
										</a>
									</li>
									<li class="nav-item">
										<a class="nav-link" data-toggle="tab" href="#eventbus` + item.id + `">
			...
			$('#homepage').append(`
				<div class="card mb-3 text-center" id="hometask` + item.id + `">
					...
					<div id="taskreminder` + item.id + `">No reminders</div>
				</div>
			`);
		}
	});
...
function editClassClick(sender) {
	var editingCourse = getCourseById(parseInt(sender.id.split(" ")[1]));
